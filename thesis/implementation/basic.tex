...
\thesislisting{simple_Ba}{behavor definition of $B_a^P$} %TODO: better name
...
The \code{def} function (figure \ref{simple_def_encoding})
is again in close correspondence with the formal encoding.
We create new \actorname{}s and spawn all necessary actors
using the \code{spawn_actor} function (figure \ref{simple_spawn_actor}),
