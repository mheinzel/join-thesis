...
\TODO{2cm}{simple translation of \joincalc into \asyncpicalc
...
\TODO{3cm}{this is not type correct\\
  typing derivation?}
...
\TODO{1cm}{turn into proof of completeness?\\
  idea:}
...
show (for some equivalence $\asymp_{A\pi}$):
...
\begin{lemma}[Preservation of structural equivalence] \label{preservation}
  f.a.
  $ S \jstructequ S' $:
...
\begin{theorem}[Completeness]
  ...
  \\
  %so there exists $Q$ with $\encMJtoAP{S} \apireduction{}^* Q$ and $Q \astructequ R$
...
\TODO{2cm}{other proofs?\\
  compositionality and name invariance should be simple,\\
  divergence reflection might be hand-wavy,\\
  I cannot do soundness.}
