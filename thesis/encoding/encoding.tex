...
\begin{align*}
  ...
  &= \anew{a}{\anew{x}{\anew{y}{\anew{l}{
    \begin{aligned}[t]
      \big(\ &\ains{B_a^P}{a}{x, y, x, l, \tilde{z}} \\
...
\TODO{1cm}{$B_{nil}$ receives continuations\\(can put $k_c$ and $k_P$ in garbage)}
...
\TODO{1cm}{same situation as before, but $\asnd{a}{x,b}$ gone, $b$ stored in list $l'$, garbage\\
...
\TODO{1cm}{substitution, $l'$ to garbage}
...
\TODO{1cm}{has same behavior to (garbage doesn't matter)}
