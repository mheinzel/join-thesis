...
by imposing a type system that statically tracks the recipients of terms.
...
are regular or only temporary assumed by an actor.
...
cannot have the \emph{name mapping properties}.
